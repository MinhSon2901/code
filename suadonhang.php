...
<div id="content-wrapper" class="d-flex flex-column">
    ...
    <tbody>
      ...
      <tr>
        <td>Tổng Tiền: <input type="text" class="t form-control bg-light border-0 small " placeholder="Thành tiền"aria-label="Search" aria-describedby="basic-addon2" name="total" value="<?php echo $fetched_row['total']; ?>"></td>
      </tr>
          </tr>
        <td>
